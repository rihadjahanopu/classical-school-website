				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
					...
					<div className="space-y-6">
						<Link
							...
							<div className="w-12 h-12 bg-accent-gold rounded-full flex items-center justify-center">
								<svg
									...
									<path
										fill="#2c5530"
										d="M20 10 L15 32 L20 25 L30 32 Z"
									/>
								</svg>
							</div>
						...
						<p className="text-white/60 leading-relaxed">
							...
							character building, and innovative learning since 1950.
						</p>
					...
					{/* Quick Links */}
					<div>
						<h6 className="text-lg font-bold text-accent-gold mb-6 uppercase tracking-wider">
							Quick Links
						</h6>
