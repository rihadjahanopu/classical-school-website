        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <p className="text-slate-600 mb-12 text-lg leading-relaxed">
              Have questions about admissions, programs, or campus life? Our team is here to help you navigate your educational journey.
            </p>

            <div className="space-y-8">
              {[
                { icon: MapPin, title: "Visit Us", details: "123 Education Drive, Greenwood, CA 90210" },
                { icon: Phone, title: "Call Us", details: "(555) 123-4567" },
                { icon: Mail, title: "Email Us", details: "info@greenwoodhigh.edu" },
              ].map((item, index) => (
                <motion.div 
                  key={index}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    className="w-full px-5 py-4 bg-slate-50 border-none rounded-2xl focus:ring-2 focus:ring-secondary transition-all resize-none"
                  ></textarea>
                </div>
